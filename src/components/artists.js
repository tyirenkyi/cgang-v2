      ...
      <ImageSwitchDiv>
        <SwitchRow>
          ...
          <SwitchButton onClick={() => switchImage('doc.JPG')}>
            <SwitchImage src={require('../assets/images/cyril.jpg')} className='wide'/>
          </SwitchButton>
          {/* <SwitchButton onClick={() => switchImage('cynmic')}>
            <SwitchImage src={require('../assets/images/cynmic.jpg')} className='long'/>
          </SwitchButton>
